...
namespace Engine
{
	...
	*/
	...
	public:
		...
		void setName(const std::string& name) override { m_name = name; } //!< Set the text labels name
		...
		const std::string& getName() const override { return m_name; } //!< Get the text labels name
